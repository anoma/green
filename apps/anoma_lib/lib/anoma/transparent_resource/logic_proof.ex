defmodule Anoma.TransparentResource.LogicProof do
  ...
  typedstruct enforce: true do
    ...
    # public inputs
    field(:commitments, MapSet.t(Resource.commitment()), default: MapSet.new())
    field(:nullifiers, MapSet.t(Resource.nullifier()), default: MapSet.new())
    field(:self_tag, {:committed, Resource.commitment()} | {:nullified, Resource.commitment()})
    field(:other_public, Noun.t(), default: <<>>)
    # private inputs
    field(:committed_plaintexts, MapSet.t(Resource.t()), default: MapSet.new())
    field(:nullified_plaintexts, MapSet.t(Resource.t()), default: MapSet.new())
